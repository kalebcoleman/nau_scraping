...
GitHub repo: [github.com/kalebcoleman/nau_course_scraping](https://github.com/kalebcoleman/nau-course-scraping)
...
others surfaced useful applied topics. The broad list is still valuable as a recall‑first
screen: I can select additional AI‑adjacent courses from these 83 candidates if needed,
but I kept the high‑confidence list at 19.
...
knitr::kable(head(ethics[, c("prefix", "number", "title")], 9), row.names = FALSE)
```
